	      	...
	      	<div id="li-comment-<?php comment_ID() ?>" class="comment-container">
	            ...
	            <?php } ?>            
		      	...
		      	<div class="comment-head">
	                ...
	                <span class="name meta-item"><?php the_commenter_link(); ?></span>           
	                <span class="date meta-item"><?php echo get_comment_date( get_option( 'date_format' ) ); ?> <?php _e( 'at', 'woothemes' ); ?> <?php echo get_comment_time( get_option( 'time_format' ) ); ?></span>
	                <span class="perma meta-item"><a href="<?php echo get_comment_link(); ?>" title="<?php esc_attr_e( 'Direct link to this comment', 'woothemes' ); ?>"><?php _e( 'Permalink', 'woothemes' ); ?></a></span>
	                <?php edit_comment_link(__( 'Edit', 'woothemes' ), '<span class="edit meta-item">', '</span>' ); ?>
